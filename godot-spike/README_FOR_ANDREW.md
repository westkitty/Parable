...
| **Left button on an object** | Grab it. Keep holding to carry it |
| **Left button on the ground + drag** | Grip the world and pan it |
| Release while moving fast | **Throw** (momentum matters) |
| Release while still | Set down gently |
| **Right button + drag** | Orbit the camera |
| **Scroll wheel** | Zoom in/out |
| **Hold Space** | Sacred gesture mode (hand points; camera locks) |
| **Space held + left-drag** | Draw a glyph |
...
3. **Pick up a rock.** Carry it around. Set it down gently. Then pick
...
6. **Hold Space** and **draw a circle** over the village with the left
   button held. That's your one starter miracle (a blessing — light
...
9. Stand near the shrine, **hold Space, and trace a vertical zigzag**
   (down-left, down-right, down-left...). The glyph flares — you have
   *learned* your second miracle.
10. Move anywhere, hold Space, and **draw the zigzag again**: a bolt.
